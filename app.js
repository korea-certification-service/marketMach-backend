...
var pointRouter = require('./backend/v2/api/marketmach/routes/point');
...
var maShop = require('./backend/v2/api/management/ma_shops');
...
app.use(version + '/point', pointRouter);
